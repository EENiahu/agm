...
function InputMaskCore(options) {
    if (!(this instanceof InputMaskCore)) {
        return new InputMaskCore(options)
    }
    options = extend({
...
function InputMask(input, options) {
    ...
    this.input.addEventListener('textInput', (e) => {
        this.textInput(e)
    });
...
InputMask.prototype.keyPress = function (e) {
...
InputMask.prototype.textInput = function (e) {
    if (e.preventDefault) {
        e.preventDefault()
    }
...
InputMask.prototype.keyUp = function (e) {
...
InputMask.prototype.cut = function (e) {
    e.preventDefault();
...
InputMask.prototype.copy = function () {
}

InputMask.prototype.paste = function (text, e) {
    text = text || '';
    ...
    this.core.paste(e ? e.clipboardData.getData('text') : text);
...
InputMask.prototype.isEmpty = function () {
...
InputMask.prototype.setInputSelection = function () {
    this.core.selection = {
        start: this.input.selectionStart,
        end: this.input.selectionEnd
    }
...
InputMask.prototype.focusOn = function (e) {
    this.setInputSelection();
...
InputMask.prototype.setCaretPosition = function (e) {
    e = e || false;
    var lastPosition = 0;
    ...
    //for TAB button(focusin event or keyUp(9))
    if (e.type == 'focusin' && e.type != 'mouseup') {
        this.core.selection = {
            start: lastPosition,
            end: lastPosition
        };
